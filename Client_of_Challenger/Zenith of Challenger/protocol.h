...
#define CS_PACKET_GAMESTART			 4			// 게임 시작 버튼
#define CS_PACKET_INGAMEREADY		 5			// 게임 시작 후 입장 완료
#define CS_PACKET_STARTZENITH		 6			// 정점 스테이지 입장 완료
...
#define SC_PACKET_GAMESTART			 104		// 게임 시작
#define SC_PACKET_REPAIRTIME		 105		// 정비 시간
#define SC_PACKET_ZENITHSTAGE		 106		// 도전 -> 정점
